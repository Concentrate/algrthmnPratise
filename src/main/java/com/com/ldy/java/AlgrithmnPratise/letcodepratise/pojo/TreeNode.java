package com.com.ldy.java.AlgrithmnPratise.letcodepratise.pojo;
...
public class TreeNode {
    ...
    private com.com.ldy.java.AlgrithmnPratise.DataStuctPratise.Tree.TreeNode<Integer> convertToNormalTreeNode(TreeNode treeNode) {
        if (treeNode == null) {
            return null;
        }
        com.com.ldy.java.AlgrithmnPratise.DataStuctPratise.Tree.TreeNode<Integer> root = new com.com.ldy.java.AlgrithmnPratise.DataStuctPratise.Tree.TreeNode<Integer>()
                .setVal(treeNode.val);
