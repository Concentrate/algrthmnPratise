...
public class TestJson {
    ...
    public static void main(String[]argv){
        try {
            File currentPackageDir=new File("test1.file");
            System.out.println(currentPackageDir.getAbsolutePath());
            InputStream inputStream=new FileInputStream(currentPackageDir.getAbsolutePath()+File.separator+"test1.file.json");
